...
<div class="i_bg">  
    ...
    <div class="content mar_20">
    	<div class="two_bg">       	
            <div class="two_t">
            	<span class="fr"><a href="AddressServlet?opr=delAddress&addressId=0">删除地址</a></span>
            	<span class="fr"><a href="NewAddress.jsp">添加新地址</a>&nbsp;&nbsp;&nbsp;</span>
            	收货人信息
            </div>
            <form action="OrderServlet?opr=addOrder" method="post">
	            <table border="0" class="peo_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
	              ...
	              <tr>
	                <td class="p_td">请选择收货地址</td>
	                <td width="395">	              
	                	<select style="width:250px" name="address">
	                		<c:forEach items="${addressList }" var="address">
	                			<option  <c:if test="${address.isDefault==1 }">selected="selected"</c:if>>	
	                				${address.userAddress }   
	                				<span> </span>      
	                			</option>>
	                		</c:forEach>	                		
	                ...
	                <td class="p_td" width="160">电子邮箱</td>
	                <td width="395">${loginUser.email }</td>
	              </tr>
	              <tr height="70">
                	<td align="center" colspan="4"><input type="image" src="images/btn_sure.gif"></td>
             	 </tr>                      
	            </table>
            </form>
