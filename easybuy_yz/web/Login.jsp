...
<body>
	...
	<div class="soubg">
		<div class="sou">
			...
			<span class="fr">
				|&nbsp;<a href="#">手机版&nbsp;<img 	src="images/s_tel.png" align="absmiddle" /></a></span>
			</span>
		</div>
	</div>
	<!--End Header End-->
	...
	<div class="log_bg">
		...
		<div class="login">
			...
			<div class="log_c">
				<form action="UserServlet?opr=login" method="post" id="loginForm">
					<table border="0" style="width: 370px; font-size: 14px; margin-top: 30px;" cellspacing="0" cellpadding="0">
						...
						<tr height="70">
							<td>密&nbsp; &nbsp; 码</td>
							<td>
								<input type="password" value="" class="l_pwd" name="password" />
							</td>
						</tr>
						<tr height="70">
							<td>验证码:</td>
						...
						<tr>
							...
							<td style="font-size: 12px; padding-top: 20px;">
								 <span id=empty style="color:red">${msg }</span>
							</td>
						</tr>
					</table>
				</form>
