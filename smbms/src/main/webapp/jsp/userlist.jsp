        ...
        <div class="right">
            ...
            <div class="search">
           		<form method="get" action="${pageContext.request.contextPath }/user/userlist.html">
					 ...
					 <a href="${pageContext.request.contextPath}/useradd2.html" >添加用户2</a>
				</form>
            </div>
            <!--用户-->
			...
			<input type="hidden" id="totalPageCount" value="${totalPageCount}"/>
          	...
          	<p>
				...
				<a href="${pageContext.request.contextPath}/user/userlist.html?pageNo=1&userName=${userName}&roleId=${roleId }">首页</a>
				<a href="${pageContext.request.contextPath}/user/userlist.html?pageNo=${pageBean.pageNo-1}&userName=${userName}&roleId=${roleId }">上一页</a>
				<a href="${pageContext.request.contextPath}/user/userlist.html?pageNo=${pageBean.pageNo+1}&userName=${userName}&roleId=${roleId }">下一页</a>
				<a href="${pageContext.request.contextPath}/user/userlist.html?pageNo=${pageBean.totalPages }&userName=${userName}&roleId=${roleId }">末页</a>
          	</p>
...
<%--	<div>--%>
<%--		<label>出生日期:</label>--%>
<%--		<input type="text" id="v_birthday" class="Wdate" onclick="WdatePickker();" value="" readonly="readonly"> --%>
<%--	</div>--%>
<%--	<div>--%>
<%--		<label>用户电话:</label>--%>
