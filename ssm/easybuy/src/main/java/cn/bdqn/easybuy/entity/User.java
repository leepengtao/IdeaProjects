...
public class User implements Serializable {
    ...
    private Integer type; // 权限 1 管理员 0 普通用户
    ...
    // 无id构造函数
    public User(String loginName, String userName, String password, int sex, String identityCode, String email, String mobile, int type) {
