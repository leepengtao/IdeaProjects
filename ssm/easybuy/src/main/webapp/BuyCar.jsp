    	...
    	<table border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0" cellpadding="0">
          ...
          <c:forEach items="${sessionScope.cart.items}" var="item" >
           <tr>
            ...
            <td align="center"><a  href="/Product/removeItem?proId=${item.product.id }">删除</a></td>
          </tr>
          </c:forEach>
          ...
          <tr height="70">
          	<td colspan="6" style="font-family:'Microsoft YaHei'; border-bottom:0;">
                ...
                <span class="fr">商品总价：<b style="font-size:22px; color:#ff4e00;">￥${sessionScope.cart.totalCost}</b></span>
            </td>
          </tr>
          <tr valign="top" height="150">
          	<td colspan="6" align="right">
            	<a href="index.jsp"><img src="images/buy1.gif" /></a>&nbsp; &nbsp; 
            	<a href="/Address/checkOrder"><img src="images/buy2.gif" /></a>
            </td>
          </tr>
        </table>
