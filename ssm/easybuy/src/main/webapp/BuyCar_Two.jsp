    ...
    <div class="sou">
        ...
        <span class="fr">
            ...
            <c:if test="${not empty userLogin}">
                ...
                |&nbsp;<a href="#">我的订单</a>&nbsp;
                |&nbsp;<a href="UserServlet?opr=logout">注销</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
...
<div class="i_bg">
    ...
    <div class="content mar_20">
        <div class="two_bg">
            ...
            <div class="two_t">
                <span class="fr"><a href="NewAddress.jsp">添加新地址</a></span>收货人信息
            </div>
            <table border="0" class="peo_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="p_td" width="160">请选择收货地址</td>
                    <td width="395">
                        <c:forEach items="${addList}" var="address">

                            <p><input type="radio" name="address"  value="${address.id}"
                                      <c:if test="${address.isDefault==1}">checked="checked"</c:if>
                            > ${address.address}

                            <%--删除地址--%>
                                <span class="fr"><a style="text-decoration:underline;color: blue" href="/Address/delAddress?id=${address.id}">删除此地址</a></span>
                            </p>

                        </c:forEach>
                    </td>
                    <td class="p_td" width="160">联系电话</td>
                    <td width="395">${userLogin.mobile}</td>
                </tr>
            ...
            <table border="0" style="width:900px; margin-top:20px;" cellspacing="0" cellpadding="0">
                ...
                <tr height="70">
                    <td align="right"><a href="/Order/addOrder"><img src="images/btn_sure.gif" /></a></td>
                </tr>
            </table>
