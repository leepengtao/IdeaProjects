        ...
        <span class="fr">
            ...
            <c:if test="${not empty userLogin}">
                <c:if test="${sessionScope.userLogin.type == 1}">
                    <span class="fl" >你好，${sessionScope.userLogin.userName}&nbsp;|&nbsp;<a href="UserManageServlet?opr=showall" style="color:red">后台管理</a>
                </c:if>
            ...
            &nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|&nbsp;<a href="UserServlet?opr=logout">注销</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
...
<div class="i_bg">
    ...
    <div class="content">
        ...
        <div id="tsShopContainer">
            <div id="tsImgS"><a href="images/${product.fileName }" title="Images" class="MagicZoom" id="MagicZoom"><img src="images/p_big.jpg" width="390" height="390" /></a></div>
            <div id="tsPicContainer">
                <div id="tsImgSArrL" onclick="tsScrollArrLeft()"></div>
                <div id="tsImgSCon">
                    <ul>
                        <li onclick="showPic(0)" rel="MagicZoom" class="tsSelectImg"><img src="images/${product.fileName }" tsImgS="images/ps1.jpg" width="79" height="79" /></li>
                        <li onclick="showPic(1)" rel="MagicZoom"><img src="images/${product.fileName }" tsImgS="images/ps2.jpg" width="79" height="79" /></li>
                        <li onclick="showPic(2)" rel="MagicZoom"><img src="images/${product.fileName }" tsImgS="images/ps3.jpg" width="79" height="79" /></li>
                        <li onclick="showPic(3)" rel="MagicZoom"><img src="images/${product.fileName }" tsImgS="images/ps4.jpg" width="79" height="79" /></li>
                        <li onclick="showPic(4)" rel="MagicZoom"><img src="images/${product.fileName }" tsImgS="images/ps1.jpg" width="79" height="79" /></li>
                        <li onclick="showPic(5)" rel="MagicZoom"><img src="images/${product.fileName }" tsImgS="images/ps2.jpg" width="79" height="79" /></li>
                        <li onclick="showPic(6)" rel="MagicZoom"><img src="images/${product.fileName }" tsImgS="images/ps3.jpg" width="79" height="79" /></li>
                        <li onclick="showPic(7)" rel="MagicZoom"><img src="images/${product.fileName }" tsImgS="images/ps4.jpg" width="79" height="79" /></li>
                    </ul>
                </div>
        ...
        <div class="pro_des">
            ...
            <div class="des_join">
            	<div class="j_nums">
                	<input type="text" value="1" name="" class="n_ipt" id="proNum"/>
                ...
                <span class="fl">
                    <a href="javascript:void(0);" id="addCart">
                        <img src="images/j_car.png" /></a></span>
            </div>            
        </div>    
        <script>
            jq(function ($){// 让渡后外面用jq, 函数后面加一个$, 里面就可以用$符号了
                $("#addCart").click(function(){
                    // 取得数量和商品ID
                    let proNum = $("#proNum").val();
                    let proId = $("#proId").val();
                    // alert(proNum+"=--"+proId);
                    location.href = "/Product/addCart?proNum=" + proNum + "&proId=" + proId;// 发送一个请求, 相当于重定向, 是一个全面泛型
                })
            })
        </script>
        <div class="s_brand">
