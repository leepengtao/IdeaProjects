...
<%--    <script type="text/javascript" src="js/registerAjaxFromNet.js"></script>--%>
...
<div class="log_bg">	
	...
	<div class="regist">
		...
		<div class="reg_c">
            ...
            <table border="0" style="width:420px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">r4
              ...
              <tr height="50">
                <td align="right"><font color="#ff4e00">*</font>&nbsp;登录名 &nbsp;</td>
                  <td><input type="text" value="" class="l_user"  id="loginName" name="loginName"/><span id="lid"></span></td>
              </tr>
              <tr height="50">
              ...
              <tr height="50">
                ...
                <td><input type="password" value="" class="l_pwd" id="repassword" name="repassword"  /></td>
              </tr>
              <tr height="50">
              ...
              <tr height="50">
                ...
                <td><input type="text" value="" name="identityCode"  id="identityCode" class="l_mem" /></td>
              </tr>
              <tr height="50">
