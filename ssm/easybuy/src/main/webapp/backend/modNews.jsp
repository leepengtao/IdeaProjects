...
<div class="container">
    ...
    <br>
    <br>
    <form action="NewsManage/modNews" method="post">
        <input value="${news.id}" name="id" hidden>

        <div class="form-group">
            <label for="title">标题：</label>
            <input type="text" class="form-control" id="title" name="title"  value="${news.title}" placeholder="请输入标题" />
        </div>

        <div class="form-group">
            <label for="content">内容：</label>
            <input rows="10" cols="20" type="text" class="form-control" id="content" name="content" value="${news.content}" placeholder="${news.content}">
