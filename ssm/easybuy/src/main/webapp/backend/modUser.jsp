...
<div class="container">
    ...
    <br>
    <br>
    <form action="/UserManage/modUser" method="post">
        <input value="${user.id}" name="id" hidden>

        <div class="form-group">
            <label for="loginName">账号：</label>
            <input type="text" class="form-control" id="loginName" name="loginName"  value="${user.loginName}" readonly="readonly" placeholder="请输入姓名" />
        </div>
